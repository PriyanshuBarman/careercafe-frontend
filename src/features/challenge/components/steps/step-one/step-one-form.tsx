...
import { CITIES, CONCERNS, SIGNALS } from "../../../constants/step-one";
            ...
            <Field data-invalid={fieldState.invalid}>
              <FieldContent className="flex-row justify-between gap-2">
                <FieldLabel htmlFor={field.name}>
                  Explain your initial hypothesis with one additional fact
                  needed.
                </FieldLabel>
              ...
              <Textarea
                ...
                aria-invalid={fieldState.invalid}
                className="text-xs disabled:cursor-not-allowed sm:text-sm"
              />
              {fieldState.invalid && (
                <FieldError className="text-xs">
                  {fieldState.error?.message}
